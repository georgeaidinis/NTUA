...
void critical_section(int i,pid_t child_ID,int my_pipe[]){
	...
	while(true){
		...
		if(x>0){
			write(my_pipe[1],&stop,sizeof(stop));
			printf("\n");
			for (j=1; j<6; j++){
